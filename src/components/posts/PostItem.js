      ...
      <div className="card card-body mb-3">
        <div className="row align-items-center">
          <div className={showActions ? "col-md-10 text-left" : "col-md-12 text-left"}>
            <div className="row align-items-center">
              <div className="col-1">
                <span><img className="rounded-circle" src={post?.author?.avatar} alt="Avatar"/></span>
              </div>
        ...
        <div classname="row">
          <div className="col-md-11 text-left">
            ...
            {post.image ? (<img style={{ width: "600px", height: "500px" }} src={"http://localhost:5000/" + post?.image} alt="Post"/>) : ('')}
          </div>
        </div>
        <hr />
        <div className="row">
            ...
            <div className="col-md-12 text-left">
              <React.Fragment>
                ...
                {post.likes.map(element => {
                  return <img style={{ height: "35px", width: "35px" }} className="rounded-circle" src={element.author.avatar} alt="Avatar"/>
                })}
              </React.Fragment>
            </div>
          )}
